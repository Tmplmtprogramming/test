...
#job_list = ['XNP-6320_H_HS', 'XNP-6371RH', 'X_Series_2M_Car_NWCAM', 'WN5_12x_Bullet_Vandal_RC']
#job_list = ['WN5_12x_Bullet_Vandal']
job_list = ['XNP-6320_H_HS', 'XNP-6371RH', 'X_Series_2M_Car_NWCAM']

#build_parameter = 'Deploy=Development&QualityReport=false&wn5=HEAD'
build_parameter ='Deploy=Stable&QualityReport=true&MAKESPARE=true&FORCE_UPGRADE_ALL=false&FW_VERSION=1.01&wn5=HEAD'
